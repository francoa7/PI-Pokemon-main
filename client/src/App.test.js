...
describe("<PostPokemon />", () => {
    describe("Estructura", () => {
        ...
        //             expect(wrapper.find('textarea[name="description"]')).toHaveLength(
        //                 1
        //             );
        //         });
        ...
        //                 wrapper.find('input[name="place"]').simulate("change", {
        //                     target: { name: "place", value: "London" },
        //                 });
        //                 expect(useState).toHaveBeenCalledWith({
        //                     title: "",
        //                     description: "",
